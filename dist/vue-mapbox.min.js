...
var n = {
        ...
        watch: (function() {
          ...
          return (
            Object.entries(s).forEach(t => {
              e[t[0]] = function(e, a) {
                return o.call(this, t[0], t[1].bind(this), e, a);
              };
            }),
            e
          );
        ...
        methods: {
          ...
          $_bindMapEvents(e) {
            Object.keys(this.$attrs).forEach(t => {
              t.startsWith("on") &&
                e.includes(t) &&
                this.map.on(t, this.$_emitMapEvent);
            });
          },
          $_unbindEvents(e) {
            e.forEach(e => {
    ...
    data: () => ({ initial: !0, initialized: !1, $_containerVNode: null }),
    computed: {
      loaded() {
    ...
    render() {
      return (
        this.$_containerVNode ||
          (this.$_containerVNode = t("div", {
            id: this.container,
            ref: "container"
          })),
        t("div", { class: "mgl-map-wrapper" }, [
          this.$_containerVNode,
    ...
    methods: {
      ...
      $_bindSelfEvents(e, t) {
        Object.keys(this.$attrs).forEach(a => {
          a.startsWith("on") && e.includes(a) && t.on(a, this.$_emitSelfEvent);
        });
      },
...
var m = {
    ...
    created() {
      ...
      (this.control = new e(this.$props)),
        this.$_addControl(),
        this.$_bindSelfEvents(Object.keys(p), this.control);
    },
    methods: {
      trigger() {
...
const y = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
  f = { click: "click", mouseenter: "mouseenter", mouseleave: "mouseleave" };
var g = {
  name: "MapMarker",
  mixins: [a, d],
  inject: ["mapbox", "map"],
...
var $ = {
    ...
    methods: {
      $_addPopup() {
        ...
        this.$_bindSelfEvents(Object.keys(v), this.popup),
    ...
    render() {
      return t("div", { style: { display: "none" } }, [this.$slots.default]);
    }
  },
  b = [
    "mousedown",
  ...
  methods: {
    ...
    $_bindLayerEvents(e) {
      Object.keys(this.$attrs).forEach(t => {
        t.startsWith("on") &&
          e.includes(t) &&
          this.map.on(t, this.layerId, this.$_emitLayerMapEvent);
      });
    },
    $_unbindEvents(e) {
      this.map &&
...
const I = a,
  ...
  L = h,
  x = _,
  E = { withEvents: a, withSelfEvents: d, asControl: h, asLayer: _ },
  k = n,
  w = l,
  B = m,
  C = u,
  ...
  j = {
    ...
    methods: {
      $_deferredMount() {
        ...
        this.$_addLayer(), this.$_bindLayerEvents(b), (this.initial = !1);
      },
      $_addLayer() {
        let e = this.map.getLayer(this.layerId);
        if (e) {
...
export {
  E as $helpers,
  M as MglAttributionControl,
  O as MglCanvasLayer,
  C as MglFullscreenControl,
  T as MglGeojsonLayer,
  B as MglGeolocateControl,
  j as MglImageLayer,
  k as MglMap,
  R as MglMarker,
  w as MglNavigationControl,
  U as MglPopup,
  A as MglRasterLayer,
  P as MglScaleControl,
  F as MglVectorLayer,
  z as MglVideoLayer,
  L as asControl,
  x as asLayer,
