(function(global, factory) {
...
})(this, function(exports, _defineProperty, _typeof, vue) {
  "use strict";
  ...
  function watcher(prop, callback, next, prev) {
    ...
    if (this.$attrs["onUpdate:".concat(prop)]) {
  ...
  var withPrivateMethods = {
    methods: {
      ...
      $_bindPropsUpdateEvents: function $_bindPropsUpdateEvents() {
        ...
        syncedProps.forEach(function(_ref) {
          ...
          events.forEach(function(event) {
            if (_this2.$attrs["onUpdate:".concat(prop)]) {
              _this2.map.on(
                event,
      ...
      $_bindMapEvents: function $_bindMapEvents(events) {
        ...
        Object.keys(this.$attrs).forEach(function(eventName) {
